...
## Cibles relecteur formel (DR-2 preuve, Q_CR.1 b)

| Priorité | Profil candidat | Scope | Contact approach |
|----------|-----------------|-------|-------------------|
...
## Cibles Intel NRC (cycle 2 only, non-blocking cycle 1)

- Outreach S9+ pour Loihi-2 access (E-SNN substrate cycle 2)

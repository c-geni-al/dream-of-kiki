# Architecture — dreamOfkiki program and hypneum-lab repositories

*Last updated : 2026-04-19 (Paper 1 v0.2 release)*

This document maps how the four public repositories of the
**hypneum-lab** research organization compose into the **dreamOfkiki**
...
The hypneum-lab repositories align on a small number of cross-cutting
...
- **`kiki-flow-research` ↔ `nerve-wml`, `micro-kiki`** : siblings
  under the hypneum-lab org, minimal direct integration.
